...
Entity setupBlock(Scene &scene,
				  ...
				  Vector3 angularVelocity = {randomFloat(), randomFloat(), randomFloat()}, Vector3 velocity = {0, 0, 0},
				  CollisionMask category = CollisionMask::FREE, unsigned int mask = CollisionMask::ALL,
